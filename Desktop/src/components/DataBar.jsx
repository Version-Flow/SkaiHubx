    ...
    <>
      ...
      <div className="contentTop">
        ...
        <ul className="quickStats">
          <li>
            <a href="#" className="blueImg"><img src="/temp/images/icons/quickstats/plus.png" alt /></a>
            <div className="floatR"><strong className="blue">5489</strong><span>visits</span></div>
          </li>
          <li>
            <a href="#" className="redImg"><img src="/temp/images/icons/quickstats/user.png" alt /></a>
            <div className="floatR"><strong className="blue">4658</strong><span>users</span></div>
          </li>
          <li>
            <a href="#" className="greenImg"><img src="/temp/images/icons/quickstats/money.png" alt /></a>
